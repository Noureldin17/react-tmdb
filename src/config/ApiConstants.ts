...
export const API_KEY = "ef16bfa151221280ed88c1b436c10876";
export const DISCOVER_MOVIES_ENDPOINT = "discover/movie?";
export const DISCOVER_TVSHOWS_ENDPOINT = "discover/tv?";
export const AIRING_TODAY_TVSHOWS_ENDPOINT = "tv/airing_today?";
export const POPULAR_TVSHOWS_ENDPOINT = "tv/popular?";
export const TOPRATED_TVSHOWS_ENDPOINT = "tv/top_rated?";
